        ...
        "columns": [
            ...
            { "data": "usertype" },
            {
                ...
                "render": function (data, type, row) {
                    return `<a href="/admin/edit-user/${row.user_id}" title="Edit" class="edit-btn" data-id="${row.user_id}" style="color: blue;"><i class="ti ti-pencil" style="font-size: 18px;"></i></a>
